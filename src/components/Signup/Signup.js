...
const Signup = () => {
    return (
        <div>
            ...
            <div className='bg-cyan-500 h-full rounded-l-lg'>
                ...
                <div className='bg-white h-full rounded-r-lg'> 
                    <h1 className='text-4xl font-bold text-cyan-500 mt-8 mb-2'>Create Account</h1>
                    ...
                    <div className='mt-8'>
                        ...
                        <label for='name'></label>
                            <input className='shadow  bg-cyan-50 w-80  h-10' placeholder='Name' type='text' name='name'></input>
                            <label for='email'></label>
                            <br></br>
                            <input className='shadow  bg-cyan-50 w-80  h-10 mt-4' placeholder='Email'type='email' name='email'></input>
